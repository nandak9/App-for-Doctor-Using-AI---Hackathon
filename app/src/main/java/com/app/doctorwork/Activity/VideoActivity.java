...
import com.app.doctorwork.BuildConfig;
import com.app.doctorwork.R;
import com.app.doctorwork.Util.CameraCapturerCompat;
import com.app.doctorwork.dialog.Dialog;
...
public class VideoActivity extends AppCompatActivity {
     ...
     */
    private static final String TWILIO_ACCESS_TOKEN = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..5EmBBtscpqZXZGyBOrjuVyg8RZoYvzk_YLJPnf4kF1c";
    private static final String ACCESS_TOKEN_SERVER = BuildConfig.TWILIO_ACCESS_TOKEN_SERVER;

    // Substitute your Twilio AccountSid and ApiKey details
    public static final String ACCOUNT_SID = "AC1928517b09d349909ecddb1232020563";
    public static final String API_KEY_SID = "SK18309c61581bc78ab4ba6eba38839773";
    public static final String API_KEY_SECRET = "oZIXaACXP8hMPLzEvr3KwGR3wmvJLqzW";
            ...
            case R.id.menu_settings:
             ...
             case R.id.speaker_menu_item:
                if (audioManager.isSpeakerphoneOn()) {
                    ...
                    item.setIcon(getResources().getDrawable(R.drawable.ic_phonelink_ring_white_24dp));
                } else {
                    audioManager.setSpeakerphoneOn(true);
    ...
    private void setAccessToken() {
        if (!BuildConfig.USE_TOKEN_SERVER) {
            ...
            try {
                ...
                final com.twilio.jwt.accesstoken.AccessToken token = new com.twilio.jwt.accesstoken.AccessToken.Builder(ACCOUNT_SID, API_KEY_SID, API_KEY_SECRET)
                        .identity("patient") // Set the Identity of this token
